 ...
 * @ORM\Entity(repositoryClass="MartinuxShop\EcommerceBundle\Repository\UtilisateurAdresseRepository")
 */
class UtilisateurAdresse
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Utilisateurs\UtilisateurBundle\Entity\Utilisateurs", inversedBy="adresse")
